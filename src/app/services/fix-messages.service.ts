...
export class FixMessagesService {
  ...
  addMessage(properties: Property[], messageType: FixMessageType = 'OINP') {
    const payload =
      this.fixMessageConverterService.convertParamsListToSerializedPayload(properties);
    switch (messageType) {
      case 'OINP': {
  ...
  modifyMessage(properties: Property[], messageType: FixMessageType) {
    const payload =
      this.fixMessageConverterService.convertParamsListToSerializedPayload(properties);
